...
const Footer = () => {
  ...
  const contactNumber2 = "+91 9876543210";
  ...
  return (
    <footer className="bg-[#1a1a1a] text-white">
      <div className="container mx-auto px-4 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-20 lg:gap-24 xl:gap-32">
          {/* Left Section - Logo & Social Media */}
          <div className="space-y-6 pr-4 md:pr-12 lg:pr-16">
            {/* Logo */}
            <Link href="/" className="inline-block">
              <h2 className="text-2xl md:text-3xl font-bold hover:opacity-80 transition-opacity">
                Rajasthan Marbles
              </h2>
            </Link>
            ...
            <div className="flex items-center space-x-4">
              {socialMediaLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-600 hover:border-white hover:bg-white/10 transition-all duration-300"
            ...
            <div className="flex items-start space-x-3 pt-2">
              ...
              <div className="flex-1">
                <p className="text-gray-300 text-sm md:text-base mb-2">
                  123, Marble Market, Industrial Area,<br />
        ...
        <div className="border-t border-gray-800 mt-16 pt-12 text-center">
          <p className="text-gray-300 text-sm">
            © {new Date().getFullYear()} Rajasthan Marbles. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
